...
export const ENV_VARS: EnvVar[] = [
  ...
  },
  {
    ...
    required: false,
    phase: 4,
    purpose: "Chat, resumos, questões, correção de redação (aceita provedor grátis compatível)",
  ...
  },
  {
    ...
    required: false,
    phase: 4,
    purpose: "Endpoint do provedor de IA (Groq, Gemini-OpenAI, OpenRouter...)",
  ...
  },
  {
    ...
    required: false,
    phase: 4,
    purpose: 'Modelo "comum" (caminho barato do roteador)',
    fallback: "gpt-4o-mini",
  },
  {
    name: "OPENAI_CHAT_MODEL_STRONG",
    required: false,
    phase: 4,
    purpose: 'Modelo "forte" (redação e pedidos complexos)',
    fallback: "usa OPENAI_CHAT_MODEL, senão gpt-4o",
  },
  {
    name: "GEMINI_API_KEY",
    required: false,
